...
import React from 'react';
import './workerprofil.css';
import { addConsultationAPICall } from '../../services/AuthService';
...
function WorkerProfil() {
  ...
  useEffect(() => {
    const storedFirstName = sessionStorage.getItem('workerEmail');
    const storedLastName = sessionStorage.getItem('workerEmail');
  ...
  const handleReserverButton = (event) => {
    event.preventDefault();
    addConsultationAPICall('amine@gmail.com', 'mouad@gmail.com')
      .then((response) => {
        console.log(response.data);
      })
      .catch((error) => {
        ...
        >
          ...
          >
            <div className="u-clearfix u-sheet u-valign-middle u-sheet-1">
              ...
              <h2 className="u-text u-text-palette-2-base u-text-2">
              ...
              <p
                ...
                data-animation-duration="1500"
              >
                Hi, I'm {firstName} . Click here to add your own text and edit
                me. ​Ut enim ad minim veniam, quis nostrud exercitation ullamco
                laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure
                dolor in reprehenderit in voluptate velit esse cillum dolore eu
                fugiat nulla pariatur.
              </p>
