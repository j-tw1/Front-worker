    ...
    <>
        <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light osahan-nav shadow-sm">
         <div class="container">
            ...
            <form class="d-none d-md-inline-block form-inline "><div class="input-group"><input class="form-control" type="text" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2"/><div class="input-group-append"><button class="btn btn-primary btn-sm" type="button"><i class="feather-search"></i></button></div></div></form>
               <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <a className="dropdown-item" href="my-profile.html"><i className="feather-edit" /> My Account</a>
                      <a className="dropdown-item" href="my-profile.html"><i className="feather-settings" /> Account Settings</a>
                      <div className="dropdown-divider" />
                      <a className="dropdown-item" href="sign-in.html"><i className="feather-log-out" /> Logout</a>
                     </div>
                  </li>
