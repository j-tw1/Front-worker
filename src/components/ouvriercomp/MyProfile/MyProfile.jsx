                ...
                <div className="row">
                  <div className="col-md-4">
                    <div className="form-group-photo">
                      ...
                      <img id="image-profile" src="https://pub-static.fotor.com/assets/projects/pages/7252c2b86395453a836cdd57b13b3d39/600w/fotor-7c742084acd7491aae9923279bdc3218.jpg" alt="Image" />
                      <label for="image-file"  id="edit-image">Edit Image</label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="gold-members11">
                    <div className="box_general padding_bottom">
                      <div className="header_box version_2 border-bottom p-3">
                        <h6 className="m-0">
                          <i className="fa fa-lock text-muted mr-2" />{' '}
                          Change password
                        </h6>
                      </div>
                      <div className="p-3">
