...
function OuvrierCard({ worker , projectss }) {
  ...
  const relevantProject = projects.find((project) => project.id === worker.id);
      ...
      <div className="col-md-4 col-sm-6 mb-4 pb-2">
        <div className="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
          <div className="list-card-image">
            ...
            <img  src={relevantProject ? relevantProject.img : 'fallback-image-url'} className="img-fluid item-img" id="im" />            </a>
          </div>
